...
describe('dateHTML', function() {
  it('parse "horas" H', function() {
    ...
    let date = moment(dateHTML('há 5 horas', now));
  ...
  it('parse "horas" HH', function() {
    let now = dateRSS('Tue, 03 Mar 1999 23:57:16 -0300');
    let date = moment(dateHTML('há 10 horas', now));
  ...
  it('parse "                    hora"', function() {
    let now = dateRSS('Tue, 03 Mar 1999 23:57:16 -0300');
    let date = moment(dateHTML('                    há 1 hora', now));
  ...
  it('parse "dias" D', function() {
    ...
    let date = moment(dateHTML('há 6 dias', now));
  ...
  it('parse "dias" DD', function() {
    let now = dateRSS('Tue, 26 Mar 1999 23:57:16 -0300');
    let date = moment(dateHTML('há 10 dias', now));
  ...
  it('parse "dia"', function() {
    let now = dateRSS('Tue, 26 Mar 1999 23:57:16 -0300');
    let date = moment(dateHTML('há 1 dia', now));
  ...
  it('parse 16/06/2016 10h13', function() {
    let date = moment(dateHTML('16/06/2016 10h13'));

    console.log(dateHTML('16/06/2016 10h13'))
